...
def finish_batch(args, filenames, original, out_imgs,
                 losses, code_batch, output_suffix, eccv_out_imgs, eccv_codes):
...
def run_eval(model, eval_loader, args, output_suffix=''):
  ...
  for i, (batch, ctx_frames, filenames) in enumerate(eval_loader):
      ...
      with torch.no_grad():
          ...
          original, out_imgs, losses, code_batch, eccv_out_imgs, eccv_codes = eval_forward(
                  model, (batch, ctx_frames), args, filenames, output_suffix)
